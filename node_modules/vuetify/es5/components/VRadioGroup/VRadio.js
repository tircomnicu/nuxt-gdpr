  ...
  methods: {
    ...
    genRadio: function genRadio() {
      return this.$createElement('div', {
        ...
        value: this.value
      }, this.attrs$)), this.genRipple(this.setTextColor(this.validationState)), this.$createElement(_VIcon.default, this.setTextColor(this.validationState, {}), this.computedIcon)]);
    },
